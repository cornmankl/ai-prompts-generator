...
const Register: React.FC = () => {
    ...
    const features = [
        { icon: Sparkles, text: 'Advanced Context Engineering' },
        { icon: Zap, text: 'Real-time AI Optimization' },
        { icon: Brain, text: 'Collaborative Prompt Building' }
    ]
                ...
                >
                    <div className="space-y-4">
                        ...
                        <p className="text-xl text-gray-600 dark:text-gray-300 max-w-md mx-auto lg:mx-0">
                            Join thousands of developers and creators building the future with AI
                        </p>
                    </div>
                    ...
                    <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-neural">
                        ...
                        <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                            <li className="flex items-center space-x-2">
                                ...
                                <span>Access to 1000+ prompt templates</span>
                            </li>
                            <li className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-success-500" />
                                <span>Advanced context engineering tools</span>
                            </li>
                            <li className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-success-500" />
                    ...
                    <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl p-8 border border-gray-200 dark:border-gray-700 shadow-neural">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">
                                Start building amazing AI prompts today
                            </p>
                        </div>
